    ...
    <SectionContainer id="home">
      ...
      <div className="flex items-center h-screen w-full down-lg:mx-auto down-lg:justify-center xs:text-left down-lg:text-center ">
        ...
        <img
          ...
          src={authorImage ? authorImage : "assets/img/perfil.jpg"}
          alt=""
        />
        {/* Desktop Image Ends */}
